...
instance {p : a -> Prop} [q : kent_convergence_space a] : kent_convergence_space (subtype p) :=
kent_convergence_space.induced coe q

instance {r : a -> a -> Prop} [q : kent_convergence_space a] : kent_convergence_space (quot r) :=
